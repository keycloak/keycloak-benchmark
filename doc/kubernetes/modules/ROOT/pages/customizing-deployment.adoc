...
Override the Keycloak hostname calculated with `KC_HOSTNAME_SUFFIX`. This is useful when deploying Keycloak with a domain
name different to the Openshfit cluster.
+
Default value: ""
