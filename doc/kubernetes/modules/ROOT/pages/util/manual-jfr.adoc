...
NOTE: Starting from Keycloak 22.0.4 it is no longer necessary to override the `-XX:FlightRecorderOptions=stackdepth` JVM option as Keycloak uses 512 by default.
