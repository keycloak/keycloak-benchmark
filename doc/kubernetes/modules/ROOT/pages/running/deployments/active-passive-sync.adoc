...
*Blueprint:* Amazon Route 53 active-passive failover.
If an availability zone goes offline, clients might fail to update their cached DNS settings and would fail to reach the secondary availability zone.
