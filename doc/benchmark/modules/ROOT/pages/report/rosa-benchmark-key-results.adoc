...
* For each 6 user logins per second, 1 vCPU per Pod in a three-node cluster (tested with up to 50 per second).
+
...
+
(18 logins per second = 3 vCPU, 450 client credential grants per second = 1 vCPU)
